package com.example.client.application.installers;

import com.example.client.application.domain.blog.author.Author;
import com.example.client.application.domain.blog.author.AuthorRepository;
import com.example.client.application.domain.blog.post.BlogPost;
import com.example.client.application.domain.blog.post.BlogPostRepository;
import com.example.client.application.domain.blog.post.PublicationSettings;
